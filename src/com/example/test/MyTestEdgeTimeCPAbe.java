...
import com.example.ciphertext.LocaleCiphertext;
import com.example.ciphertext.Message;
import com.example.globalAuthority.GlobalParam;
import org.apache.log4j.Logger;
import com.example.timeParam.EncParam;
import com.example.userKey.UserAuthorityKey;
import com.example.userKey.UserSplitKeys;
import com.example.userKey.Userkeys;
import com.example.util.EdgeCPAbe;
import com.example.util.EdgeTimeCPAbe;
import com.example.util.RateRandomNumber;
import com.example.util.Wallet;
...
public class MyTestEdgeTimeCPAbe implements TimeEdgeCPABE {
    ...
    public static void testODCPABE() {
        ...
        // 所有属性集
        String[] attributes = {"a", "b", "c", "d", "e", "f", "g", "h"};
        System.out.println("属性：" + Arrays.toString(attributes));
        // 属性机构数量
        int AAs = 3;
        System.out.println("为AA分配地址，为属性分配AA");
